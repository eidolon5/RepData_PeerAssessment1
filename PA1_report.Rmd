...
The average steps taken on weekdays is shown on the top of the last graph and the average steps taken on weekends is show on the bottom. The mean and the median of average steps taken on weekdays are `r wkdaymean` and `r wkdaymedian`, respectively. The mean and median of average steps taken on weekends are `r wkendmean` and `r wkendmedian`, respectively. The average steps taken on the weekends is greater than the average steps taken on weekdays.
